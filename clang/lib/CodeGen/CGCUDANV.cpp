...
Address CGNVCUDARuntime::prepareKernelArgsLLVMOffload(CodeGenFunction &CGF,
  ...
  llvm::StructType *KernelArgsTy =
      llvm::StructType::create(CGF.Builder.getContext(), ArgTypes);
...
void CGNVCUDARuntime::emitDeviceStubBodyNew(CodeGenFunction &CGF,
  ...
  Address KernelArgs = UseLLVMOffload ? prepareKernelArgsLLVMOffload(CGF, Args)
  ...
  auto LaunchKernelName = UseLLVMOffload ? "__llvm" + KernelLaunchAPI
